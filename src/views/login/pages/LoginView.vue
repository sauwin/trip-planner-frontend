...
<template>
  <div class="min-h-screen flex" style="background-color: var(--color-paper)">
    ...
    <div
      ...
      style="background: linear-gradient(135deg, var(--color-accent-light) 0%, var(--color-accent) 48%, var(--color-accent-dark) 100%)"
    >
      <!-- ambient glow -->
      ...
      <div class="relative max-w-sm">
        <p class="tag-mono text-xs font-bold tracking-widest uppercase mb-4" style="color: rgba(255,255,255,0.7)">{{ t('auth.welcomeBack') }}</p>
        ...
        <p class="text-base" style="color: rgba(255,255,255,0.75); line-height: 1.6">
          {{ t('auth.loginSubtext') }}
        </p>
      </div>
      ...
      <div class="relative">
        <svg viewBox="0 0 360 130" class="w-full h-auto" aria-hidden="true">
          <path
            d="M10 100 C 90 100, 100 30, 180 40 S 300 90, 350 20"
            fill="none"
            ...
            class="route-path"
          />
          <circle cx="10" cy="100" r="4" fill="white" class="route-dot" style="animation-delay: 0s" />
          <circle cx="180" cy="40" r="4" fill="white" class="route-dot" style="animation-delay: 0.6s" />
          <circle cx="350" cy="20" r="4" fill="white" class="route-dot" style="animation-delay: 1.2s" />
        </svg>
        <div class="flex justify-between mt-2 tag-mono text-[0.65rem]" style="color: rgba(255,255,255,0.55)">
          <span>48.85°N, 2.35°E</span>
          <span>35.68°N, 139.69°E</span>
          <span>−33.86°N, 151.20°E</span>
        </div>
      </div>
    </div>
